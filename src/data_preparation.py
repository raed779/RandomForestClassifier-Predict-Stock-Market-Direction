...
Indicateur=pd.read_csv("src/prepare_data/Indicateur.csv", sep = ',')
AMZN_=pd.read_csv("src/prepare_data/AMZN_.csv", sep = ',')
SP500=pd.read_csv("src/prepare_data/SP500.csv", sep = ',')

Indicateur=Indicateur.set_index("Date")
AMZN_=AMZN_.set_index("Date")
